...
const Slider = () => {
    ...
    return (
        <div className='min-h-screen py-40 lg:py-10 flex overflow-hidden gap-30 w-full bg-black'>

            <div className="hidden 2xl:inline-block absolute left-60 h-40 md:h-screen w-xl bg-gradient-to-r from-black to-transparent z-8 pointer-events-none" />
            ...
            <div className="hidden 2xl:inline-block absolute right-60 h-full w-xl bg-gradient-to-l from-black to-transparent z-8 pointer-events-none" />
        </div>
