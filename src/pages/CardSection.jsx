...
const CardSection = () => {
    return (
        <div id='product' className='min-h-screen flex flex-col items-center justify-center gap-20 px-4 md:px-6 py-18 lg:py-30 xl:py-50 text-center w-full bg-white rounded-4xl mt-3'>
