...
const Pricing = () => {
    return (
        <div id='about' className='md:h-100 w-full text-black bg-[#FFEF46] gap-8 md:gap-1 rounded-3xl md:rounded-[3rem] mt-1.5 md:mt-3 flex lg:flex-row md:flex-row flex-col text-center justify-center md:justify-between md:items-end px-10 py-15 md:py-2 md:pb-13 md:px-16 lg:px-20 2xl:px-25'>
